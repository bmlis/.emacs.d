...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (0blayout ace-window ranger evil use-package scpaste smex magit find-file-in-project ido-ubiquitous idle-highlight-mode paredit better-defaults))))
(custom-set-faces
